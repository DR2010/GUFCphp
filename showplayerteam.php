...
<html lang="en">
    ...
    <body>
		...
		<?php
			...
			// echo "Last updated on Monday 03 April 2017 at 09:45AM.";
...
//	$sqlplayer = "SELECT FirstName, LastName, fkteamid, fkagegroupid  FROM player where LastName = ".$lastname." and display = 'Y' ";
	// echo $sqlplayer;
